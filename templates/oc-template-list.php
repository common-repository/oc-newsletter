...
<div class="card container">
                      ...
                      <form class="" name="oc-template-form" method="post" action="<?php echo esc_html($action); ?>">
                                ...
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-3">
                                        <div class="form-group">
                                           <h3 class="card-block__title margin-top-10"><?php echo esc_html("Template/Email Name"); ?></h3>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 offset-margin-left-30">
                                        <div class="form-group">
                                            <input type="text" name="oc-template-name" class="form-control form-control-danger" value="<?php echo esc_html($oc_tmpname); ?>" placeholder="Template/Email Name" id="oc-template-name" pattern="[a-zA-Z\s]+" required>
                                ...
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-3">
                                        <div class="form-group">
                                           <h3 class="card-block__title margin-top-10"><?php echo esc_html("Template/Email Subject"); ?></h3>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 offset-margin-left-30">
                                        <div class="form-group">
                                            <input type="text" name="oc-template-subject" value="<?php echo esc_html($oc_tmpsubject); ?>" class="form-control form-control-danger" value="" placeholder="Template/Email Subject" id="oc-template-subject" required>
                                            <i class="form-group__bar"></i>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-5 col-sm-5">
                                ...
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 col-sm-3">
                                        <div class="form-group">
                                           <h3 class="card-block__title margin-top-10"><?php echo esc_html("Template/Email Body"); ?></h3>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 offset-margin-left-30">
